...
from typing import Any, Final, Generic, NoReturn, TypeVar, overload
...
class Comment:
    ...
    def set(
        ...
        item: _Index | _Key,
        pos: int,
        value: CommentToken | list[CommentToken] | list[str] | None,
    ) -> None: ...  # RTSC
...
class CommentedMap(ordereddict[_KT, _VT], CommentedBase):
    ...
    def mlget(self, key: list[_Index | _Key], default: _D | None = None, list_ok: bool = False) -> Any: ...
    ...
    # copilot: comments.py forwards arbitrary mapping or pair-iterable input to ordereddict.update and records own keys.
    def update(self, *vals: Mapping[_KT, _VT] | Iterable[tuple[_KT, _VT]], **kw: _VT) -> None: ...
    def copy(self) -> Self: ...
    def __deepcopy__(self, memo: dict[int, Any]) -> Self: ...
...
class CommentedKeyMap(CommentedBase, Mapping[_KT, _VT]):
    ...
    def __init__(
        self, *args: Mapping[_KT, _VT] | Iterable[tuple[_KT, _VT]], **kwargs: _VT
    ) -> None: ...
    ...
    @classmethod
    # copilot: comments.py accidentally omits cls in this classmethod, so normal bound calls pass the class as keys and raise TypeError.
